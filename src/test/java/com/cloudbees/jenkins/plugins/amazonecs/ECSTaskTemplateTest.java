...
public class ECSTaskTemplateTest {
    ...
    ECSTaskTemplate getParent() {
        return new ECSTaskTemplate(
                ...
                null, null, "parent-image", "parent-repository-credentials", "FARGATE", "Windows", "parent-network-mode", "parent-remoteFSRoot",
    ...
    ECSTaskTemplate getChild(String parent) {
        return new ECSTaskTemplate(
                ...
                null, null, "child-image", "child-repository-credentials", "EC2", "Windows", "child-network-mode", "child-remoteFSRoot",
                false, null, 0, 0, 0, null, null, false, false,
